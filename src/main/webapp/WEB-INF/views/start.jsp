...
<t:layout>
	...
	<jsp:attribute name="rightTeaser">
	    ...
	    <!-- 
	   	<div class="rightcolumn">
	     	<h1>Kinderkegeln</h1>
	      	Die Kinder-Stadtmeisterschaft findet dieses Jahr am <b>2. Februar</b> sowie <b>2. März</b> von <b>10:00 Uhr bis 16:00 Uhr</b> im <b>Haus Padberg</b> statt.
	      	<br /><br /><b>Modus:</b><br />
	   	...
	   	<div class="rightcolumn">
	   		<h1>Tandemkegeln</h1>
	   		Die Tandemmeisterschaft wird parallel zur Kinder-Stadtmeisterschaft am <b>2. Februar</b> sowie <b>2. März</b> von <b>10:00 Uhr bis 16:00 Uhr</b> im <b>Haus Padberg</b> ausgetragen.
	   		Mitmachen kann Jeder, auch wenn man nicht an der offiziellen Stadtmeisterschaft teilnimmt. 
	   		<br /><br /><b>Modus:</b><br />
	   		Zwei Personen (Damen- / Herren- / Mixed-Wertung) kegeln zusammen auf Bahn 1 - fünf Wurf in die Vollen pro Person. 
	   		Es folgen wieder jeweils fünf Wurf in die Vollen auf Bahn 2. 
	   		...
	   		Gewertet wird nur das beste Ergebnis pro Paarung. 
		</div>
	     -->
	   	<!-- End Right Content -->
	</jsp:attribute>
